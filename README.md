...
_"Criar um projeto com o objetivo de validar o cadastro enviando uma chave única ao email do novo usuário, tendo um design simples e belo, 
com intuito de promover o aprendizado e gerar um projeto utilizando o Django framework."_
...
```
git clone git@github.com:LucasSantus/send_email.git
...
python manage.py makemigrations send
...
Este projeto está licenciado sob a Licença MIT License - veja o [LICENSE.md](https://github.com/LucasSantus/send_email/blob/master/LICENSE) para melhores detalhes.
